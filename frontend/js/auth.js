document.addEventListener('DOMContentLoaded', () => {
    ...
    if (loginForm) {
        loginForm.addEventListener('submit', async (e) => {
            ...
            const isAdminPage = document.querySelector('h1').textContent.toLowerCase().includes('admin');
            const endpoint = isAdminPage ? 'http://127.0.0.1:5000/api/admin/login' : 'http://127.0.0.1:5000/api/user/login';
